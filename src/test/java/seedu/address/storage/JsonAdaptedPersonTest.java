...
public class JsonAdaptedPersonTest {
    ...
    private static final String VALID_GROUP_ID = BENSON.getGroupId().getValue();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_STUDENT_ID, INVALID_NAME, VALID_PHONE,
                        VALID_EMAIL, VALID_GROUP_ID, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_STUDENT_ID, VALID_NAME, VALID_PHONE,
                        INVALID_EMAIL, VALID_GROUP_ID, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_STUDENT_ID, VALID_NAME, VALID_PHONE,
                        null, VALID_GROUP_ID, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_STUDENT_ID, VALID_NAME, VALID_PHONE,
                        VALID_EMAIL, VALID_GROUP_ID, INVALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_STUDENT_ID, VALID_NAME, VALID_PHONE,
                        VALID_EMAIL, VALID_GROUP_ID, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_STUDENT_ID, VALID_NAME, VALID_PHONE,
                        VALID_EMAIL, VALID_GROUP_ID, VALID_ADDRESS, invalidTags);
